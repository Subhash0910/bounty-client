        ...
        <div style={{
          ...
          <div style={{ padding: '2.4rem 2.6rem 2rem' }}>
            ...
            <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
              ...
              <h2 style={{ color: '#00f5d4', fontSize: '1.3rem', fontWeight: 900, letterSpacing: '0.25em', margin: 0 }}>LOGIN</h2>
              <p style={{ color: '#0f2535', fontSize: '10px', letterSpacing: '4px', margin: '6px 0 0' }}>RETURN TO THE OCEAN</p>
            </div>
            ...
            <Link to="/register" style={{ color: '#0f2535', display: 'block', textAlign: 'center', fontSize: '11px', letterSpacing: '2px', textDecoration: 'none', transition: 'color 0.15s' }}
